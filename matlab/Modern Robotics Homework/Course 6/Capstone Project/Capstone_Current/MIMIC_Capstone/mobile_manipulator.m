% Subclass mobile_manipulator, with a 5R robot arm articulated on the mobile base
classdef mobile_manipulator < robot_base
    ...
    methods
        function obj = mobile_manipulator(half_length,half_width,wheel_radius,T_b0,M_0e,Blists,thetalist)
            % Construct the mobile_manipulator AT its zero position
            % using robot arm configuration
            obj@robot_base(half_length,half_width,wheel_radius);
            obj.Blists = Blists;
            if nargin < 7
                obj.M_be = T_b0*M_0e;
            else 
       ...
       function obj = nextState(obj,config,speed,dt,maxSpeed)
            ...
            % subclass "mobile_manipulator" could do whole body kinematic by
            ...
            obj = nextState@robot_base(obj,speed(1:4),dt,maxSpeed(1:4));
