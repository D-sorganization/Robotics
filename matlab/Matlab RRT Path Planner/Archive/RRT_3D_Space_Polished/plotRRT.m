...
ax = gca;
ax.Color = 'k'; % make plot area black too
ax.XColor = 'w';
ax.YColor = 'w';
ax.ZColor = 'w';
ax.GridColor = 'w';
ax.BoxStyle = 'full'; % full 3D box
...
% Load Falcon STL (new thick version)
[fv.vertices, fv.faces] = stlread('falcon_simple_thick.stl');
original_vertices = fv.vertices; % already 3D
